...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Shahadath multipurpose laravel tabmplate " name="description" />
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <img class="rounded-circle header-profile-user" src="{{ asset('assets/admin/images/users/avatar-1.jpg')}}"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1">Shahadath</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <form method="post" action="{{ route('logout')}}">
                                    @csrf
                                    <button class="dropdown-item text-da"> <i class="ri-shut-down-line align-middle me-1 text-danger"></i> Logout </button>
                                </form>
            ...
            <div class="vertical-menu">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div class="user-profile text-center mt-3">
                        ...
                        <div class="mt-3">
                            <h4 class="font-size-16 mb-1">Shahadath Hossain</h4>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="/home">Recover Password</a></li>
                                </ul>
                            </li>
